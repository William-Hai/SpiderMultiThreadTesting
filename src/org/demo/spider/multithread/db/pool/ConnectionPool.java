...
public class ConnectionPool {
    ...
    protected ConnectionPool(String jdbcDriver, String dbUrl, String dbUsername, String dbPassword) {
    ...
    /**
     * 创建由 numConnections 指定数目的数据库连接 , 
     * 并把这些连接放入 connections 向量中
     * 
    ...
    private void wait(int mSeconds) {
        try {
            ...
            System.err.println(ConnectionPool.class.getSimpleName() + ": " + e);
        }
    }
